...
public class StageGame2Controller implements Initializable {
...
// create a node group
    ...
    @FXML
    private void toPrintStatement(MouseEvent event ) throws IOException {
         if (Login.mute == false) { playAudioSelect(); }
            System.out.println(" Enter Print statement 1 "); 
            FXMLLoader loaderP = new FXMLLoader();
            loaderP.setLocation(getClass().getResource("PrintStatement.fxml"));
            AnchorPane rootP = loaderP.load();
            Scene sceneP = new Scene(rootP);            
            PrintStatementController controllerP = loaderP.getController();
            controllerP.initData(newPlayer);
            
            System.out.println(" Enter PrintStatement Controller ");
     ...
     @FXML
    private void toVaribels(MouseEvent event ) throws IOException {
         if (Login.mute == false) { playAudioSelect(); }
            System.out.println(" Enter Varibels "); 
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("Varibels.fxml"));
            AnchorPane root = loader.load();
            Scene scene = new Scene(root);            
            VaribelsController controllerP = loader.getController();
            controllerP.initData(newPlayer);
