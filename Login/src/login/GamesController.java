...
// create a node group
    ...
    private StackPane stage5BtLockStack;
     ...
     private HBox cmdsPane;
       ...
       @FXML
    private void arrowMove(MouseEvent event) throws IOException {
  ...
  /*   @FXML
    ...
    private void toMainMenuArrow(MouseEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader();
            ...
            AnchorPane root2 = loader.load();//0000000000000000000
   ...
   @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Game g1 = (Game) session.get(Game.class, 1);
        game1.setText(g1.getName());
        transaction.commit();
        session.close();
        */
...
t5.getKeyFrames().add(new KeyFrame(
   ...
   if(player.getLevel().getCode()<=3) {
    ...
    newPlayer.setScore(player.getScore());
     ...
     @FXML
    private void toStageGame2(ActionEvent event) throws IOException {
        if (Login.mute == false) { playAudioSelect(); }
            System.out.println("To Stage Game Arwa Al- mashi ");
            FXMLLoader loaderG2 = new FXMLLoader();
            loaderG2.setLocation(getClass().getResource("StageGame2.fxml"));
            AnchorPane rootG2 = loaderG2.load();
            Scene sceneG2 = new Scene(rootG2);            
            StageGame2Controller controllerG2 = loaderG2.getController();
            controllerG2.initData(newPlayer);
            Stage window = (Stage) ((Node)event.getSource()).getScene().getWindow();
            window.setScene(sceneG2);
            window.show(); 
            System.out.println("FINALLLLL ARWAAAAAA");
   }
